...
class MovieControllerTest {
    ...
    void getPopularMovies() throws Exception {
        ...
        given(movieService.getPopular()).willReturn(resultFromGetConfig);
    ...
    void getTopRated() throws Exception {
        ...
        given(movieService.getTopRated()).willReturn(resultFromGetConfig);
    ...
    void getMovieById() throws Exception {
        ...
        given(movieService.getMovieById(id)).willReturn(resultFromGetConfig);
    ...
    void getCastAndCrew() throws Exception {
        ...
        given(movieService.getCastAndCrew(id)).willReturn(resultFromGetConfig);
    ...
    void getImages() throws Exception {
        ...
        given(movieService.getAllImages(id)).willReturn(resultFromGetConfig);
    ...
    void getKeywords() throws Exception {
        ...
        given(movieService.getKeywords(id)).willReturn(resultFromGetConfig);
    ...
    void getRecommendations() throws Exception {
        ...
        given(movieService.getRecommendations(id)).willReturn(resultFromGetConfig);
    ...
    void getSimilar() throws Exception {
        ...
        given(movieService.getSimilarMovies(id)).willReturn(resultFromGetConfig);
